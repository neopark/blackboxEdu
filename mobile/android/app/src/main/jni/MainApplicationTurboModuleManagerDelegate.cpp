  ...
  namespace react {
    ...
    void MainApplicationTurboModuleManagerDelegate::registerNatives() {
      registerHybrid({
        ...
        makeNativeMethod("canCreateTurboModule", MainApplicationTurboModuleManagerDelegate::canCreateTurboModule),
      });
    }
    ...
    bool MainApplicationTurboModuleManagerDelegate::canCreateTurboModule(std::string name) {
